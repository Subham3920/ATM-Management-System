...
class Bank:
    def __init__(self,root):
        ...
        self.root = root
        self.header = Label(self.root,text="ATM BANK",bg="salmon",fg="white",font="arial 20 bold")
    ...
    def database_fetch(self):
        ...
        for i in self.temp:
            self.acc_list.append("Name = Jatin".format(i[0]))
            self.acc_list.append("Account no = 1".format(i[2]))
            self.acc_list.append("Account type = Saving".format(i[3]))
            self.ac = i[2]
